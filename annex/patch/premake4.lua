	...
	newoption
	{
		trigger = "nvpro-includes",
		description = "Allow nvpro_core includes for RTX raycasting backend, place nvpro_core as sibling folder to bullet3."
	}
...
if os.is("Linux") then
 		...
 		default_python_include_dir = "/usr/local/include/vulkan1.4.309.0"
end
...
if os.is("Windows") then
 		...
 		default_python_include_dir = "C:/VulkanSDK/1.4.309.0/Include"
 		default_python_include_dir = "C:/VulkanSDK/1.4.309.0/Lib"
end
    ...
    newoption
    {
			trigger     = "vulkan_include_dir",
			value       = default_vulkan_include_dir,
			description = "Vulkan 1.4 include directory"
    }
    
    newoption
    {
			trigger     = "vulkan_lib_dir",
			value       = default_vulkan_lib_dir,
			description = "Vulkan 1.4 library directory"
    }
...
if os.is("Windows") then
	...
	if _OPTIONS["nvpro-includes"] then
		...
		configuration "Debug"
			libdirs {
				"../../nvpro_core/build/Debug",
				"../../nvpro_core/build/third_party/fmt.dir/Debug"
			}
		configuration "Release"
			libdirs {
				"../../nvpro_core/build/Release",
				"../../nvpro_core/build/third_party/fmt.dir/Release"
			}
		configuration {}
