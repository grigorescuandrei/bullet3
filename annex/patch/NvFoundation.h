...
#elif(defined(NV_GNUC) || defined(NV_VC) || defined(NV_GHS)) && !defined(__PS4__)  // ps4 doesn't like restricted functions
...
#elif defined(NV_GNUC) || defined(NV_GHS) || (defined(__APPLE__) && defined(__arm__) /* IOS */)
